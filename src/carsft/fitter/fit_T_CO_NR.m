function [xfit,resnorm,theory] = fit_T_CO_NR(sqrtflag)
...
function plot_fit_results(x,S,sqrtflag)
  ...
  annotation('textbox',[0.30, 0.90, 0, 0],'String',['T = ' num2str(x(1)) ' K'],'FontSize',25,'EdgeColor','none','FitBoxToText','on');
  annotation('textbox',[0.30, 0.82, 0, 0],'String',['CO/N_2 = ' num2str(x(2))],'FontSize',25,'EdgeColor','none','FitBoxToText','on');
  annotation('textbox',[0.30, 0.74, 0, 0],'String',['\alpha = ' num2str(x(3))],'FontSize',25,'EdgeColor','none','FitBoxToText','on');
