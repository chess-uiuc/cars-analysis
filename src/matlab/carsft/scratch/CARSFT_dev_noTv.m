function [S,CHI,w,E3,w3] = CARSFT_dev_noTv(wexp,T,P,X,dtp,dtau3,alpha,dwp) 
...
wmin = 2000;wmax = 2380;dw = 0.001;  %hard wire the wavenumber grid for now
...
voigt_threshold = 1000; %thereshold ratio of Doppler to collision width that throws flag for voigt lineshape model
