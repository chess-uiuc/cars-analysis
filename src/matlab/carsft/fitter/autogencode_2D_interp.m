function [x,resnorm,residual,exitflag,output,lambda,jacobian] = autogencode_2D_interp(x0,lb,ub,PrecondBandWidth_Data)
...
lsqnonlin(@CARS_resid_2Dlib_interp,x0,lb,ub,options);
