function [S,CHI,w,E3,w3] = CARSFT_dev_new(wexp,T,P,X,dtp,dtau3,alpha,dwp) 
...
[wraman(:,kk),gamma(:,kk),branch,qn{:,kk}] = get_trans(molpar.gasname(kgas),molpar,T,Tv,wexp);   

%compute the Raman resonant amplitude of each line
[chiamp(:,kk)] = get_chiamp(molpar.gasname(kgas),molpar,branchname,T,Tv,QN);
